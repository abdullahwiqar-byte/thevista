...
<section
  id="home"
  className="relative bg-cover bg-center bg-no-repeat text-white h-[70vh] min-h-[560px] max-h-[720px] overflow-hidden max-w-7xl mx-auto rounded-2xl aspect-[16/9] sm:aspect-[16/8]"
