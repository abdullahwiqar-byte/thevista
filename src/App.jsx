...
<section
  id="home"
  className="relative bg-cover bg-center bg-no-repeat text-white h-[70vh] min-h-[560px] max-h-[720px] overflow-hidden max-w-7xl mx-auto rounded-2xl aspect-[16/10] sm:aspect-[16/9]"
...
<div className="mt-4">
  ...
  {/* <span className="ml-3 text-xs text-slate-500">~3.2 MB</span> */}
    ...
    {/* Building Features */}
    <Fade>
      <h2 className="mt-16 text-3xl md:text-4xl font-bold tracking-tight">Building Features</h2>
    </Fade>
